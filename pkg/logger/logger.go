...
func Debug(args ...any)                 { defaultLogger.log(LevelDebug, "%s", fmt.Sprint(args...)) }
func Debugf(format string, args ...any) { defaultLogger.log(LevelDebug, format, args...) }
func Info(args ...any)                  { defaultLogger.log(LevelInfo, "%s", fmt.Sprint(args...)) }
func Infof(format string, args ...any)  { defaultLogger.log(LevelInfo, format, args...) }
func Warn(args ...any)                  { defaultLogger.log(LevelWarn, "%s", fmt.Sprint(args...)) }
func Warnf(format string, args ...any)  { defaultLogger.log(LevelWarn, format, args...) }
func Error(args ...any)                 { defaultLogger.log(LevelError, "%s", fmt.Sprint(args...)) }
func Errorf(format string, args ...any) { defaultLogger.log(LevelError, format, args...) }
func Fatal(args ...any)                 { defaultLogger.log(LevelError, "%s", fmt.Sprint(args...)) }
func Fatalf(format string, args ...any) { defaultLogger.log(LevelError, format, args...) }
...
func (l *Logger) log(level LogLevel, format string, args ...any) {
	...
	style := errorStyle
	if strings.Contains(format, "fatal") || strings.Contains(format, "Fatal") {
		isFatal = true
		levelStr = "FATAL"
